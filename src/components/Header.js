  ...
  return (
    <div>
      <div className="bg-secondary  text-text text-center text-md min-h-8 grid grid-flow-col grid-cols-3">
        <div className="place-self-center  p-2 mr-4">
          ...
          <a href="tel:805-406-9107">
            <div className="flex items-center group bg-base hover:bg-text rounded-full cursor-pointer px-10 py-2 duration-300">
              <button>
        ...
        <div className="flex items-center justify-center ">
          <div className="flex justify-center cursor-pointer hover:bg-base duration-200 group min-w-[60px] hover:rounded-md h-full">
            <button>
              <i className="fa-brands group-hover:text-white text-alt fa-facebook"></i>
            </button>
          </div>
          <div className="flex justify-center cursor-pointer hover:bg-base  group min-w-[60px] h-full hover:rounded-md duration-200">
            <button>
          ...
          <a
            ...
            className="flex justify-center hover:bg-base group cursor-pointer min-w-[60px] h-full hover:rounded-md duration-200"
          >
            <div className="flex ">
              <button>
        ...
        <div className=" none items-center flex w-full bg-base opacity-0  justify-center">
          *Free Estimates*
        </div>
      </div>
      ...
      <div className=" flex justify-center items-center  text-text bg-secondary ">
        <div className="w-[90px] py-3 cursor-pointer justify-center flex hover:bg-alt hover:text-secondary hover:rounded-lg duration-200">
          <a href="#About">
            <button className="">About</button>
          </a>
        </div>
        <div className="w-[90px] py-3 justify-center flex hover:bg-alt hover:text-base hover:rounded-lg duration-200">
          <a href="#Services">
